...
let navItemsUpperParts = document.getElementsByClassName("upperNavItemsForClassChange");
...
let classForButtonsForModeChange = document.getElementsByClassName("classForButtonsForModeChange");
// ------Main--Footer--Section------//
...
function LightAndDarkMode()
{
    ...
    else 
    {
        ...
        for(let tempI = 0; tempI < navItemsUpperParts.length ; tempI++)
        {
            navItemsUpperParts[tempI].classList.remove("darkModeNAVBarItemsHoverClass");
